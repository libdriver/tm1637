...
LibDriver TM1637是LibDriver推出的TM1637全功能驱动，该驱动提供数码管显示、键盘扫描等功能并且它符合MISRA标准。
...
/src目录包含了LibDriver TM1637的源文件。

/interface目录包含了LibDriver TM1637与平台无关的IIC总线模板。

/test目录包含了LibDriver TM1637驱动测试程序，该程序可以简单的测试芯片必要功能。

/example目录包含了LibDriver TM1637编程范例。

/doc目录包含了LibDriver TM1637离线文档。

/datasheet目录包含了TM1637数据手册。
...
在线文档: [https://www.libdriver.com/docs/tm1637/index.html](https://www.libdriver.com/docs/tm1637/index.html)。
